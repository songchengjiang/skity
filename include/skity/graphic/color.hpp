...
#ifndef INCLUDE_SKITY_GRAPHIC_COLOR_HPP
#define INCLUDE_SKITY_GRAPHIC_COLOR_HPP
 ...
 */
SKITY_API constexpr inline Color ColorSetARGB(uint8_t a, uint8_t r, uint8_t g,
                                              uint8_t b) {
 ...
 */
SKITY_API constexpr inline Color ColorSetA(Color c, uint8_t a) {
...
SKITY_API Color ColorMakeFromHSLA(float h, float s, float l, uint8_t a);
...
#endif  // INCLUDE_SKITY_GRAPHIC_COLOR_HPP
